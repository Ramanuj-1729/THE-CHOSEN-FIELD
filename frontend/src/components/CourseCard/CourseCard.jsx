    ...
    return (
        <div data-aos={aos}>
            <div style={{ boxShadow: 'rgba(0, 0, 0, 0.08) 0px 4px 12px' }} className="flex justify-center rounded cursor-pointer transition ease-in-out delay-150 hover:scale-105">
                <img className="desktop:w-64 rounded-s" src={courseImage} alt="" />
                <div className="flex justify-center flex-col p-4 w-full">
                    <h3 className="text-xl font-medium text-font_one">{courseName}</h3>
                    <p className="mt-2 mb-3 text-sm text-font_two font-medium">{description}</p>
                    ...
                    <div className="border-t-2 border-[#bdbdbd] flex justify-between items-center pt-2" >
