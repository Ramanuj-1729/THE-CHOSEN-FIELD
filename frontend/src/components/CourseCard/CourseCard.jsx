...
const CourseCard = ({ courseImage, courseName, description, instructorImage, instructorName, price, off, duration, mode, aos }) => {
    return (
        <div className="w-full" data-aos={aos}>
            <div style={{ boxShadow: 'rgba(0, 0, 0, 0.08) 0px 4px 12px' }} className="flex largePhone:flex-row smallPhone:flex-col justify-center rounded cursor-pointer transition ease-in-out delay-150 hover:scale-105">
                <img className="desktop:w-64 largeTablet:w-52 smallTablet:w-56 largePhone:w-48 smallPhone:w-full largePhone:rounded-l smallPhone:rounded-t" src={courseImage} alt="" />
                <div className="flex justify-center flex-col smallTablet:p-4 smallPhone:p-3 w-full">
                    ...
                    <div className="flex items-center">
                        <img className="desktop:w-8 largeTablet:w-6 smallTablet:w-7 smallPhone:w-7 desktop:h-8 largeTablet:h-6 smallTablet:h-7 smallPhone:h-6 rounded-full mr-3" src={instructorImage} alt="" />
