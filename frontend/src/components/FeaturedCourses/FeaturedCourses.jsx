...
const FeaturedCourses = () => {
    return (
        <Section heading="Featured Courses" subHeading="Explore Our Popular Online Courses" bgColor="#ffffff">
            <ScrollToTopNavLink to="/courses" className='absolute top-[115px] right-0 border-2 border-primary px-10 py-2 text-font_two text-lg font-medium rounded transition ease-in-out delay-150 hover:bg-primary hover:text-white'>View All</ScrollToTopNavLink>
