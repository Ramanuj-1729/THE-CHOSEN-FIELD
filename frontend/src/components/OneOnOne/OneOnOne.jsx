    ...
    return (
        <Section heading="One-on-One Interaction" subHeading="Let's connect for a personalized conversation tailored just for you!" bgColor="#F8F8F8">
            <div data-aos="zoom-in-up" style={{ boxShadow: 'rgba(0, 0, 0, 0.08) 0px 4px 12px' }} className='flex p-5 rounded-xl bg-white'>
                <img style={{ boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px' }} className='wideScreen:w-[480px] desktop:w-[430px] largeTablet:w-[380px] rounded-md mr-10' src="images/OneOnOne.png" alt="" />
                <div className='flex flex-col justify-between pl-10 border-l-2 border-dashed border-gray w-full'>
                    <div className='mt-2'>
                        <h2 className='desktop:text-3xl largeTablet:text-2xl text-font_one font-semibold desktop:mb-5 largeTablet:mb-3'>Personalized 1:1 Experience</h2>
                        <p className='desktop:text-base largeTablet:text-sm text-font_two font-normal text-justify'>We offer weekly One-on-One interaction to our students. Interested students can register by clicking on the button below and get a sneak peek of the same</p>
                    </div>

                    <div className='desktop:space-y-8 largeTablet:space-y-5'>
                    ...
                    <NavLink to="https://meetpro.club/TheChosenField" className="text-primary border-2 border-primary text-lg font-medium desktop:py-3 largeTablet:py-2 flex justify-center rounded-full mr-5 transition ease-in-out delay-150 hover:bg-primary hover:text-white">Book Now</NavLink>
                </div>
            </div>
        </Section>
    );
