...
const OurTeam = () => {
    return (
        <Section heading="Our Team" subHeading="Meet your Educator" bgColor="#FFFFFF" >
            <ScrollToTopNavLink to="/about" className='absolute largeTablet:top-[115px] mediumTablet:top-[70px] smallTablet:top-[35px] largeTablet:right-0 mediumTablet:-right-8 smallTablet:-right-2 border-2 border-primary desktop:px-10 largeTablet:px-8 mediumTablet:px-7 smallTablet:px-5 mediumTablet:py-2 smallTablet:py-1 text-font_two desktop:text-lg smallTablet:text-base font-medium rounded transition ease-in-out delay-150 hover:bg-primary hover:text-white'>Know More</ScrollToTopNavLink>
            <div data-aos="fade-up" className="flex items-center flex-col">
                <img className="largeTablet:w-52 smallTablet:w-40 rounded-full border-4 border-primary mb-2" src="images/admin1.jpg" alt="" />
            ...
            <div data-aos="fade-up" className="mt-12 flex items-center flex-col">
                <img className="largeTablet:w-56 smallTablet:w-40 mb-2" src="images/Unacademy-logo.png" alt="" />
