...
const WhyTheChosenField = () => {
    return (
        <Section heading="WHY THE CHOSEN FIELD ?" subHeading={`Making learning easier and more convenient for you`} bgColor="#F8F8F8">
            <div className="grid largeTablet:grid-cols-3 smallTablet:grid-cols-2 largePhone:grid-cols-2 desktop:gap-6 largeTablet:gap-4 smallTablet:gap-3 largePhone:gap-3">
