...
const Footer = () => {
    return (
        ...
        <div className="bg-[#9EC4C9] relative">
            <div className="flex mediumTablet:flex-row smallTablet:flex-col justify-between desktop:mx-36 largeTablet:mx-16 smallTablet:mx-5 mediumTablet:py-16 smallTablet:py-10">
                <div className="flex flex-col mr-5">
                    ...
                    <span className="text-primary largeTablet:space-x-5 smallTablet:space-x-3 mediumTablet:mt-5 mediumTablet:my-0 smallTablet:my-5">
                    ...
                    <div className="absolute largeTablet:bottom-3 mediumTablet:bottom-20 mediumTablet:top-auto smallTablet:top-10 desktop:right-40 largeTablet:right-24 mediumTablet:right-16 smallTablet:right-10 flex items-center flex-col">
                ...
                <div className="flex w-full text-base justify-between">
                    <ul className="largeTablet:mr-0 mediumTablet:mr-3">
