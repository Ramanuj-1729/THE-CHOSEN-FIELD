...
const Navbar = () => {
    ...
    return (
        <div style={navBgStyle} className='flex desktop:mx-36 largeTablet:mx-20 mediumTablet:mx-12 smallTablet:mx-8 largePhone:mx-8 py-5 pl-5 items-center absolute top-[6.3rem] left-0 right-0 z-10'>
            <ul className='flex text-white space-x-10 smallTablet:text-base largePhone:text-base'>
