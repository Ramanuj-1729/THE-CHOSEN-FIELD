...
const About = () => {
    return (
        <>
            ...
            <div className='wideScreen:px-36 desktop:px-28 largeTablet:px-16 my-20 overflow-hidden'>
                <div className='flex items-center space-x-10 mb-10'>
                    <img data-aos="fade-right" className='desktop:w-[580px] largeTablet:w-[450px] rounded-3xl' src="images/admin2.jpg" alt="instructor-about" />
                ...
                <div className='flex items-center space-x-10'>
                    ...
                    <img data-aos="fade-left" className='desktop:w-[580px] largeTablet:w-[450px] rounded-3xl' src="images/admin1.jpg" alt="instructor-story" />
                </div>
