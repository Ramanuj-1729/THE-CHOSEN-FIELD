  ...
  return (
    <>
      ...
      <div
        ...
        className="flex mx-40 my-20 rounded-md"
      >
        <div>
          <iframe
            title="map"
        ...
        <div className="space-y-5 p-10">
          <h2 className="text-3xl text-font_one font-medium">Contact Us</h2>
          <p className="text-base text-font_two opacity-80">
            We're open for any suggestion or just to have a chat
          </p>
          <div className="flex space-x-5">
            <div className="flex-1">
              <span className="text-base text-font_one font-medium">
                ADDRESS
              </span>
              <p className="text-font_two text-sm leading-6 mt-2">
                Mahamaya Mandir lane, Raika, Narwal, Jammu 180006
              </p>
>>>>>>> cb03035f4ac0ad4eaaade241d340ff2c5262fbb5
            </div>
            <div className="flex-1">
              <span className="text-base text-font_one font-medium">EMAIL</span>
              <p className="text-font_two text-sm leading-6 mt-2">
                sajjadqureshi326@gmail.com
              </p>
            </div>
            <div className="flex-1">
              <span className="text-base text-font_one font-medium">PHONE</span>
